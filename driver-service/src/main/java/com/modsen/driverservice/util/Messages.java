...
public class Messages {
    ...
    public final String NOT_FOUND_WITH_DRIVER_ID_MESSAGE = "Driver with id %s was not found";
    ...
    public final String DELETE_DRIVER_MESSAGE = "Driver with id %s was deleted";
    public final String EDIT_DRIVER_STATUS_MESSAGE = "Status for driver with id %s was changed";
    public final String UNAVAILABLE_DRIVER_MESSAGE = "Driver with id %s unavailable";
